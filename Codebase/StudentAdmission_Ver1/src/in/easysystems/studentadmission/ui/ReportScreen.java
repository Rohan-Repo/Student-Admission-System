...
public class ReportScreen extends JFrame 
{
	...
	JButton btnDateReport, btnBalanceReport, btnStudentWiseReport, btnCourseWiseReport;
	...
	public ReportScreen() 
	{
		...
		btnDateReport.setBounds( 10, 10, 150, 30 );
		
		btnBalanceReport = new JButton( "Balance Report" );
		btnBalanceReport.setBounds( 10, 100, 150, 30 );
