...
public class DateReportScreen extends JFrame 
{
	/**
	 * 
	 */
	...
	public DateReportScreen() 
	{
		...
		lblDateWise.setBounds( 10, 10, 200, 30 );
		...
		btnRetrieveReport.addActionListener( new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if( chkSingleDate.isSelected() )
				{
					...
					double sum = DBOperations.getFeesSumSingle( localDate );
				...
				if( chkDateRange.isSelected() )
				{
					...
					double sum = DBOperations.getFeesSumRange(dateStart, dateEnd);
					String dateStr = "From " + txtDateRangeStart.getText() + " to " + txtDateRangeEnd.getText();
					DateReportScreen.this.dispose();
					new StudentReport( "Student Fees Collection Report", true,  dateStr, model, sum );
