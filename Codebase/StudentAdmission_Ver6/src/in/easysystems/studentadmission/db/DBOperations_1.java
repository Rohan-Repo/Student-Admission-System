...
public class DBOperations_1 extends BaseConnection
{
...
//				studentList.add( list );
	...
	public static  DefaultTableModel retreiveDateRangeReport( LocalDate dateStart, LocalDate dateEnd ) 
	{
		...
		try
		{
			...
			for(  i=1 ; i<=columnCnt ; i++ )
			{
				vectorColumnNames.addElement( metaData.getColumnLabel(i) );
	...
	public static  float getFeesSumSingle( LocalDate date ) 
	{
	...
	public static  float getFeesSumRange( LocalDate dateStart, LocalDate dateEnd ) 
	{
