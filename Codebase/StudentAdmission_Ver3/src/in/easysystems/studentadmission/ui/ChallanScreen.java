		...
		btnSubmit.addActionListener( new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if( studentList.balanceFees > 0 && studentList.balanceFees < currentInstallment )
				{
					...
					int opr = JOptionPane.showOptionDialog( ChallanScreen.this, "This is Advance Fees", "Advance Fees Notification", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[1]);
