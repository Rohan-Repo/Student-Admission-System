...
public class ReportScreen extends JDialog 
{
	...
	JButton btnDateReport, btnBalanceReport, btnStudentWiseReport, btnCourseWiseReport, btnBack;
	...
	public ReportScreen() 
	{
		...
		//ImageIcon backIcon = new ImageIcon("/Copy of StudentAdmission/src/Images/back.gif");
		...
		btnDateReport.setBounds( 100, 100, 150, 30 );
		...
		btnStudentWiseReport.addActionListener( new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				new StudentReport( "Student Wise List", false, null, tableModel , 0);
		...
		btnCourseWiseReport.addActionListener( new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				new StudentReport( "Course Wise List", false, null, tableModel , 0);
		...
		btnBalanceReport.addActionListener( new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				new StudentReport( "Student Fees Balance Report", false, null, tableModel , 0);
