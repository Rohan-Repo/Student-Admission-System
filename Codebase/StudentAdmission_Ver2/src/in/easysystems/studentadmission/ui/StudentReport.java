...
public class StudentReport extends JDialog
{
	...
	public StudentReport( String reportName, boolean isDateReport, String rangeString, DefaultTableModel tableModelStudent, double sum ) 
	{
		...
		if( isDateReport )
		{
			...
			String total = "Total Amount Received = " + sum; 
