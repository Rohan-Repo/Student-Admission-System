...
public class AddStudentInfoScreen extends JDialog
{
	...
	public AddStudentInfoScreen( int studentRegID ) 
	{
		...
		try 
		{
			...
			academicYearStartArr = new String[5];
			academicYearEndArr = new String[5];
			...
			comboYearStart.addActionListener( new ActionListener() {
		...
		btnSubmit.addActionListener( new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				if( txtLineOne.toString().length() > 100 || txtLineTwo.toString().length() > 100 || txtLineThree.toString().length() > 100 )
				{
				 	txtLineOne.setText("");
