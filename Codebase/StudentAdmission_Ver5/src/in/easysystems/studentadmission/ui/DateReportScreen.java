	...
	public DateReportScreen() 
	{
		...
		btnRetrieveReport.addActionListener( new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if( chkSingleDate.isSelected() == false && chkDateRange.isSelected() == false )
				{
					JOptionPane.showMessageDialog( DateReportScreen.this, "Kindly Select an Option!!!", "ERROR", JOptionPane.ERROR_MESSAGE );
					return;
				}
				else
				{
